import { ListaCircularSimple } from './lista.js';
import { bootbox_prompt, bootbox_alert } from '../utils/dialog.js';

let lista = null;

export async function agregar_inicio_lstCir() {
    ...
    try {
        ...
        //listaCir.dibujarNodos(DATO);
        //listaCir.dibujarCola();
...
export async function agregar_final_lstCir() {
    var canvas = document.getElementById('tutorial');
    if (lista == null) {
        lista = new ListaCircularSimple();
        lista.canvas = canvas;
...
export async function agregar_antes_X_lstCir() {
    var canvas = document.getElementById('tutorial');
    if (lista == null) {
        lista = new ListaCircularSimple();
        lista.canvas = canvas;
...
export async function agregar_despues_X_lstCir() {
    var canvas = document.getElementById('tutorial');
    if (lista == null) {
        lista = new ListaCircularSimple();
        lista.canvas = canvas;
...
export async function eliminar_inicio_lstCir() {
    var canvas = document.getElementById('tutorial');
    if (lista == null) {
        lista = new ListaCircularSimple();
        lista.canvas = canvas;
...
export async function eliminar_final_lstCir() {
    var canvas = document.getElementById('tutorial');
    if (lista == null) {
        lista = new ListaCircularSimple();
        lista.canvas = canvas;
...
export async function eliminar_X_lstCir() {
    var canvas = document.getElementById('tutorial');
    if (lista == null) {
        lista = new ListaCircularSimple();
        lista.canvas = canvas;
...
export async function eliminar_antes_X_lstCir() {
    var canvas = document.getElementById('tutorial');
    if (lista == null) {
        lista = new ListaCircularSimple();
        lista.canvas = canvas;
...
export async function eliminar_despues_X_lstCir() {
    var canvas = document.getElementById('tutorial');
    if (lista == null) {
        lista = new ListaCircularSimple();
        lista.canvas = canvas;
